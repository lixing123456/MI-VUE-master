  ...
  <div class="loginContent">
    <div style="padding-bottom: 2.5rem;">
      ...
      <label class="labelBox label_user">
        ...
        <input v-model="userName" class="item_account" autocomplete="off" type="tel" name="user" placeholder="手机号码"
      ...
      <label class="labelBox label_cmsCode">
        <input v-model="password" class="item_account" autocomplete="off" :type="passwordType" name="user"
          placeholder="输入6位数字密码" />
      </label>
      <div class="actionButton loginRegisBtn" @click="login()">已有账号/立即登录</div>
      <div class="actionButton loginTypeChange" @click="tologin()">没有账号/立即注册</div>
        ...
        axios
          ...
          .then(result => {
            ...
            if (parseInt(result.code) === 0) {
              ...
              setTimeout(this.$router.replace("/myself"), 2000);
            } else {
              this.$toast.fail({
                message: "登录失败"
              });
